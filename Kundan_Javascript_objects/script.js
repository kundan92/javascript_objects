...
function question02(){		
		var intro=["RED","GREEN","WHITE","BLACK","BLUE"];
		
		var result = intro.join();
		document.write("Joint strings are <b>"+result+"</b>");		
	}
...
function question11(){		
	...
	function validate(input){
		...
		document.write("The number of vowels in the string is <b>"+counter+"</b>.");
	}
